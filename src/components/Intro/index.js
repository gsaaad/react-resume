  ...
  return (
    <section className="grid grid-rows-1 md:grid-cols-2 xl:p-16">
      <div className="photo-container col m-4">
        ...
        />
        <div>
          <p className="intro-descp text-lg m-4 mt-8 lg:text-2xl xl:text-3xl">
      ...
      <div className="intro-self col ">
        ...
        <p className="intro-descp2 text-lg m-4  mt-8 lg:text-3xl ">
        ...
        <p className="intro-descp2 text-lg lg:text-3xl ">
          A proven leader and{" "}
        ...
        <p className="intro-descp3 text-lg   lg:text-3xl ">
